...
{\begin{itemize}[leftmargin=0.6cm, label={\textbullet}]
	\item \textbf{System/Network/Devops}: Windows, Linux, Git, ELK, Docker
...
\customcventry{03/2020 - 09/2021}{{\color{blue}\href{https://eximbank.com.vn}{(Eximbank)}}}{Corebanking Developer,}{Quận 3, Tp. HCM}{}
{\begin{itemize}[leftmargin=0.6cm, label={\textbullet}]
	\item Phát triển các báo cáo dùng oracle bi publisher trong Datawarehouse (PLSQL).
\end{itemize}}
