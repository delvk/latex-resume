...
\makecvtitle
\vspace*{-13mm}
\begin{center}\textbf{ Software Developer and Corebanking Technical Solution DevOps }\end{center}
\begin{center}
\begin{tabular}{ c c c }
\quad\faMobile\enskip +84 919922081 & \quad\faEnvelope\enskip nbkhuong97@gmail.com & \quad\faHome\enskip Ho Chi Minh City, Vietnam \\
\faLinkedin\enskip \color{blue} \href{https://www.linkedin.com/in/khuong-nguyen76/}{in/khuong-nguyen76} &
\faGithub\enspace \color{blue} \href{https://github.com/delvk}{github.com/delvk} & \faGitlab\enspace \color{blue} \href{https://gitlab.com/delvk}{gitlab.com/delvk}
\end{tabular}
\end{center}

\section{Giới thiêu bản thân}

{Chuyên viên lập trình phát triển ứng dụng Corebanking hơn 4.5 năm kinh nghiệm, Chuyền về các module Account, Depo, GL. Đã tham gia và hoàn thành nhiều dự án yêu cầu phát triển \& tích hợp phía corebank. Từng làm việc với các hệ thống Corebank Infosys, Symbol và sắp tới là Transact. Thành thạo Oracle, PLSQL.}

\section{Kỹ năng chuyên môn}
{Corebanking Developer - Oracle - PLSQL - REST Api - Data Analysis - Golang developer - Corebanking Intergration - Technical Solution Specialist - Database Management - Development and Operation - Automation Testing}
...
\section{Chứng chỉ}
{\begin{itemize}[leftmargin=0.6cm, label={\textbullet}]
      \item Microsoft Certified: Azure Fundamentals (03/07/2022) - \underline{\color{blue}\href{https://drive.google.com/file/d/1qxYfcd0UYsWdJNqyOZ2rfYVV3GqyhA4x/view?usp=sharing}{AZ-900}}
      \item Toeic Listening \& Reading Certified: 905 (04/04/2019) - \underline{\color{blue}\href{https://drive.google.com/file/d/1RHzD2srmD5mtvXiPQpjvhY7--DFvFiKc/view?usp=sharing}{TOEIC}}
      \item Cisco Certified Network Associate (01/01/1999) - \underline{\color{blue}\href{https://google.com/}{CCNA}}
  \end{itemize}} 
